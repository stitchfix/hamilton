from hamilton.function_modifiers import parameterized_inputs, parametrized_input
...
@parameterized_inputs(output_12={"input_value_tbd1": "input_1", "input_value_tbd2": "input_2"})
